      ...
      <div class="row">
        <div class="row align-item-center py-5">
          <div class="col-lg-6 col-12 mb-4">
            <img src="{{url('frontend/images/About/about-1.jpg')}}" alt="" width="100%" height="100%" class="img-fluid">
          </div>
          <div class="col-lg-6 col-12 mb-4">
        ...
        <div class="row">
          <div class="col-md-3 mb-5">
            <div class="card menu-card">
              <div class="menu-img">
                <img src="{{url('frontend/images/menu/M1.jpg')}}" class="img-fluid">
              </div>
              ...
              <div class="order-detail">
                <a href="{{url('/menu')}}" class="btn Btn">View menu</a>
              </div>
            </div>
          </div>
          <div class="col-md-3 mb-5">
            <div class="card menu-card">
              <div class="menu-img">
                <img src="{{url('frontend/images/menu/M2.jpg')}}" class="img-fluid">
              </div>
              <div class="d-flex align-item-center justify-content-between">
                <h3>Shawarma</h3>
                <span>Rs:300</span>
